...
const { documentUploadSchema } = require('../validators/schemas');
...
router.post('/upload', authMiddleware, requirePlan('basic'), upload.single('file'), validateRequest(documentUploadSchema), documentController.uploadDocument);
